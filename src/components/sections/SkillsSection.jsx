import { Code2, Layers, GraduationCap, Terminal, Computer } from 'lucide-react';
...
const TechIcons = {
  ...
  VSC: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 32 32" fill="currentColor" {...props}>
...
const getSkillIcon = (skillName) => {
  ...
  switch (true) {
    ...
    case lower.includes('typescript'): return <TechIcons.TypeScript className="size-5 text-[#3178C6]" />;
    case lower.includes('vitest'): return <TechIcons.Vitest className="size-5 text-[#00FF74]" />;
    case lower.includes('testing library'): return <TechIcons.TestinLibrary className="size-5 text-[#E33332]" />;
    ...
    case lower.includes('vsc'): return <TechIcons.VSC className="size-5 text-[#007ACC]" />;
        ...
        <div className="md:col-span-1 md:row-span-2 group relative p-8 bg-slate-900/60 border border-slate-800 rounded-3xl hover:border-indigo-500/30 transition-all duration-500 flex flex-col">
          ...
          <div className="space-y-8 relative z-10">
            ...
            <div className="relative pl-12 opacity-80 hover:opacity-100 transition-opacity">
              ...
              <div className="flex flex-col">
                <span className="text-xs text-slate-400 mb-1">2023 - 2025</span>
                <h4 className="font-bold text-slate-200 leading-tight mb-1">Técnico Superior DAW</h4>
                <span className="text-slate-400 text-sm">ILERNA FP Online</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="relative z-10">
              ...
              <div className="flex items-center gap-3">
                <div>
                  ...
                  <p className="text-base text-slate-400 my-2">
                    Son las tecnologías con las que estoy <span className="font-bold text-indigo-300">profundizando en el desarrollo frontend moderno</span>. Con cada proyecto busco entender mejor el ecosistema de React, escribir código más limpio y construir interfaces modernas y funcionales.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {PROJECTS_DATA.skills.focus_actual.map(skill => (
                <div key={skill} className="flex items-center gap-2 px-2.5 py-1.5 bg-slate-800/50 border border-slate-700 hover:border-sky-500/50 hover:bg-slate-800 text-slate-200 rounded-lg transition-all duration-300 group/skill cursor-default">
                  {getSkillIcon(skill)}
