...
const TechIcons = {
  ...
  JavaScript: (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M0 0h24v24H0V0zm22.034 18.276c-.175-1.095-.888-2.015-3.003-2.873-.736-.345-1.554-.585-1.797-1.14-.091-.33-.105-.51-.046-.705.15-.646.915-.84 1.515-.66.39.12.75.42.976.9 1.034-.676 1.034-.676 1.755-1.125-.27-.42-.404-.601-.586-.78-.63-.705-1.469-1.065-2.834-1.034l-.705.089c-.676.165-1.32.525-1.71 1.005-1.14 1.291-.811 3.541.569 4.471 1.365 1.02 3.361 1.244 3.616 2.205.24 1.17-.87 1.545-1.966 1.41-.811-.18-1.26-.586-1.755-1.336l-1.83 1.051c.21.48.45.689.81 1.109 1.74 1.756 6.09 1.666 6.871-1.004.029-.09.24-.705.074-1.65l.046.067zm-8.983-7.245h-2.248c0 1.938-.009 3.864-.009 5.805 0 1.232.063 2.363-.138 2.711-.33.689-1.18.601-1.566.48-.396-.196-.597-.466-.83-.855-.063-.105-.11-.196-.127-.196l-1.825 1.125c.305.63.75 1.172 1.324 1.517.855.51 2.004.675 3.207.405.783-.226 1.458-.691 1.811-1.411.51-1.095.402-2.239.402-3.965V11.031z" /></svg>
  ),
  PHP: (props) => (
  ...
  Git: (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M23.546 10.93L13.067.452c-.604-.603-1.582-.603-2.188 0L8.708 2.627l2.76 2.76c.645-.215 1.379-.07 1.889.441.516.515.658 1.258.438 1.9l2.658 2.66c.645-.223 1.387-.078 1.9.435.721.72.721 1.884 0 2.604-.719.719-1.881.719-2.604 0-.539-.541-.674-1.337-.404-1.996L12.86 8.955v6.525c.176.086.342.203.488.348.713.721.713 1.883 0 2.606-.718.721-1.883.721-2.605 0-.718-.723-.718-1.885 0-2.606.126-.126.27-.233.425-.316v-6.52c-.615.241-1.339.11-1.872-.425l-2.761-2.76L.454 10.93c-.604.603-.604 1.582 0 2.188l10.48 10.48c.604.604 1.582.604 2.188 0l10.43-10.48a1.55 1.55 0 0 0 0-2.188z" /></svg>
  ),
  GitHub: (props) => (
  ...
  CSS3: (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.325 3.426-2.91.804-2.955-.81-.188-2.11H6.248l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531z" /></svg>
  ),
  Sass: (props) => (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-1 md:row-span-2 group relative p-8 bg-slate-900/60 border border-slate-800 rounded-3xl hover:border-indigo-500/30 transition-all duration-500 flex flex-col">
          ...
          <div className="flex items-center gap-3 mb-8 relative z-10">
            <div className="p-3 bg-indigo-500/10 rounded-xl text-indigo-400"><GraduationCap className="w-6 h-6" /></div>
            <h3 className="text-xl font-bold text-slate-100">Mi Formación</h3>
          </div>
          ...
          <div className="space-y-8 relative z-10">
            ...
            {/* DAW */}
            <div className="relative pl-12 opacity-80 hover:opacity-100 transition-opacity">
              <div className="absolute left-4 top-2 w-2 h-2 rounded-full bg-slate-700 z-10"></div>
              <div className="flex flex-col">
                <span className="text-xs text-slate-500 mb-1">2023 - 2025</span>
                <h4 className="font-bold text-slate-300 leading-tight mb-1">Técnico Superior DAW</h4>
                <span className="text-slate-500 text-sm">ILERNA FP</span>
              </div>
            </div>
          </div>
        </div>
